...
(defn component* [id, content-all]
  (fn [props]
    [:div (conj props
                {:id id})
     [:div {:class ["absolute", "bottom-[39%]", "flex", "flex-col", "font-extrabold", "gap-[3vh]", "px-6", "text-[1.1rem]", "portrait:md:text-[1.75rem]","lg:text-[1.75rem]", "portrait:lg:text-[2rem]" "text-[#f9eac4]"]}
